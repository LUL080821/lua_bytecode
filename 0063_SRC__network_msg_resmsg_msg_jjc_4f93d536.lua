...
function MSG_JJC.RegisterMsg()
    ...
    Network.CreatRespond("MSG_JJC.ResGetFirstReward",function (msg)
        GameCenter.ArenaShouXiSystem:ResGetFirstReward(msg);
    end)


    Network.CreatRespond("MSG_JJC.ResBuyJJCTimes",function (msg)
        --TODO
        GameCenter.ArenaShouXiSystem:ResBuyJJCTimes(msg)
    end)
