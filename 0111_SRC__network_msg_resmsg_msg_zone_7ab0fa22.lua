...
function MSG_zone.RegisterMsg()
    ...
    Network.CreatRespond("MSG_zone.ResEnterZoneTeamInfo",function (msg)
        ...
        GameCenter.PushFixEvent(UIEventDefine.UICopyTeamPrepareForm_OPEN, msg);
    end)
    ...
    Network.CreatRespond("MSG_zone.ResBossStateResultPanl",function (msg)
        GameCenter.MapLogicSystem:OnMsgHandle(msg)
    end)


    Network.CreatRespond("MSG_zone.G2PReqEnterZone",function (msg)
        --TODO
    end)


    Network.CreatRespond("MSG_zone.P2GReqMatchSucceed",function (msg)
        --TODO
    end)


    Network.CreatRespond("MSG_zone.G2PReqCrossZoneReadyZone",function (msg)
        --TODO
    end)


    Network.CreatRespond("MSG_zone.G2PReqCancelMatch",function (msg)
        --TODO
    end)


    Network.CreatRespond("MSG_zone.P2GReqCancelCrossTag",function (msg)
        --TODO
    end)
