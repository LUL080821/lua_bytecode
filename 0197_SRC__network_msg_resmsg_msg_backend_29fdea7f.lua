...
function MSG_Backend.RegisterMsg()
    ...
    Network.CreatRespond("MSG_Backend.ResFuncOpenReward",function (msg)
        --TODO
    end)
    ...
    Network.CreatRespond("MSG_Backend.P2GNoticeSynData",function (msg)
        --TODO
    end)


    Network.CreatRespond("MSG_Backend.G2PReqCrossRank",function (msg)
        --TODO
    end)


    Network.CreatRespond("MSG_Backend.G2PReqCrossRankDataIsReceive",function (msg)
        --TODO
    end)


    Network.CreatRespond("MSG_Backend.G2PReqCrossRankData",function (msg)
        --TODO
    end)
